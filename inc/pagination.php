...
if ($page > 1)
	$pagination.= "<a href='".$path."&amp;page=$prev'>« wczesniejsze</a>";
else
	$pagination.= "<span class='disabled'>« cofnij</span>";   
...
if ($page < $counter - 1)
	$pagination.= "<a href='".$path."&amp;page=$next'>dalej »</a>";
else
	$pagination.= "<span class='disabled'>dalej »</span>";
	$pagination.= "</div>\n";       
}
